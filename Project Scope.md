...
* Concept: A fountain of colourful particles that burst and fall with gravity, reacting to mouse/touch input. We can provide 3 types of particle fountains: Party confetti poppers (multiple colours), fireworks (multiple varieties), and galactic aurora (inspired by the Milky Way). The perspective is similar to looking up at the night sky, watching confetti explode at 10ft above the user, watching fireworks explode between 100ft to 400ft and watching galactic aurora spawn far away in the night sky.
